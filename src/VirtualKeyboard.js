...
class VirtualKeyboard extends Component {
    ...
    Backspace() {
        return (
            <TouchableOpacity accessibilityLabel='backspace' style={styles.backspace} onPress={() => {
                this.onPress('back')
            }}>
                <Image source={this.props.backspaceImg} resizeMode='contain'
    ...
    Cell(symbol) {
        return (
            <TouchableOpacity style={[styles.cell, this.props.style.cell]} key={symbol}
                              accessibilityLabel={symbol.toString()} onPress={() => {
                this.onPress(symbol.toString())
            }}>
                <Text style={[styles.number, this.props.style.number, {color: this.props.color}]}>{symbol}</Text>
            </TouchableOpacity>
        );
    }
